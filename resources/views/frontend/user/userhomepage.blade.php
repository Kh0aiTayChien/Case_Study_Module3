...
//                    foreach ($users as $user) :?>
                    ...
                    <td>
                        <div class="card" style="width: 18rem; height: 14rem ">
                            <img width="300px" src="logo.png" alt="user">
                            <div class="card-body">
                                <h5 class="card-title"> Ten Co Gai</h5>
                                <p class="card-text"> Tuoi </p>
                                <p class="card-text"> Địa điểm  </p>
                                <p class="card-text"> Giá t  </p>
                                <a href="#" class="btn btn-outline-primary btn-lg btn-block"> Đặt thuê ngay </a>
                            </div>
                        </div>
                    </td>
                    <td>
